...
ADVISORS_RESULT_SPREADSHEET_ID = env('ADVISORS_RESULT_SPREADSHEET_ID')
ADVISORS_QUESTIONS_SPREADSHEET_ID = env('ADVISORS_QUESTIONS_SPREADSHEET_ID')
ADVISORS_BOT_TOKE = env('ADVISORS_BOT_TOKE')

ADVISORS_MCVP_BOT_TOKEN = env('ADVISORS_MCVP_BOT_TOKEN')
